...
import { Shield, Eye, EyeOff, ArrowLeft, ChefHat } from 'lucide-react';
...
export default function LoginComidaPage() {
  ...
  const theme = getAgentTheme('comida');

  // Verificar si ya está autenticado
  useEffect(() => {
    const isAuthenticated = sessionStorage.getItem('comida_authenticated');
    if (isAuthenticated === 'true') {
      router.push('/dashboard/comida');
    }
  }, [router]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (username === CREDENTIALS.username && password === CREDENTIALS.password) {
      ...
      sessionStorage.setItem('comida_authenticated', 'true');
      sessionStorage.setItem('comida_auth_time', new Date().toISOString());

      // Redirigir al dashboard de comida
      router.push('/dashboard/comida');
    } else {
    ...
    <div className="min-h-screen bg-black overflow-hidden relative">
      ...
      <div className="relative z-10 min-h-screen flex flex-col justify-center items-center px-4">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-white/70">Emiliano la Taquería</p>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  required
                  className="border-white/20 bg-white/5 text-white placeholder-white/40 focus:border-orange-400/60 focus:ring-orange-400/20"
                  disabled={isLoading}
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    required
                    className="border-white/20 bg-white/5 text-white placeholder-white/40 focus:border-orange-400/60 focus:ring-orange-400/20 pr-10"
                    disabled={isLoading}
                  />
                  <button
                    type="button"
            ...
            <div className="mt-6 pt-6 border-t border-white/10">
              <div className="text-center">
                <p className="text-xs text-white/50 mb-3">
                  Acceso autorizado únicamente para personal de Emilianos la Taquería.
                </p>
                <div className="flex justify-center gap-4">
                  <Link href="/login/salud">
                    ...
                    >
                      ← Ir a Login de Vive Feliz Sin Dolor
                    </Button>
                  </Link>
                </div>
              </div>
